...
If anyone listening to this thought "Oh my what an engaging chap. I wish we could have him to talk" - The answer is yes you can! Just give me a ping.
...
You can read the paper [here](https://www.medrxiv.org/content/10.1101/2022.10.12.22280917v1.full.pdf). If interested in the code repository you can check it out [here](https://github.com/epiforecasts/simplified-forecaster-evaluation). Slides for this talk are available [here](https://samabbott.co.uk/presentations/2023/IISA-surrogate-ensemble-forecasting-hub.pdf).
...
- [`{epinowcast}`](https://epinowcast.org): Aiming to deal with some of the issues I outlined above.
