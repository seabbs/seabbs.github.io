...
- Exploration of methods for estimating the generation time distribution (the distribution of the time between infection a primary case and infection in a secondary case) - this is a related but distinct problem.
